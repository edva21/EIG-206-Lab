 ...
 * @author edva5
 */
public class EstudiantePrincipalVista {
    ...
    private ArrayList<TableColumn<Estudiante,String>> admiTableColumns;
    private Alert alert;
    public EstudiantePrincipalVista() {
        ...
        table=(TableView<Estudiante>) root.lookup("#table");
     ...
     * @return the table
     */
    public TableView<Estudiante> getTable() {
        return table;
    }
     ...
     */
    public void setTable(TableView<Estudiante> table) {
        this.table = table;
    }
    /**
     * @return the admiTableColumns
     */
    public ArrayList<TableColumn<Estudiante,String>> getAdmiTableColumns() {
     ...
     */
    public void setAdmiTableColumns(ArrayList<TableColumn<Estudiante,String>> admiTableColumns) {
